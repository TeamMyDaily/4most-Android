...
class RemindWriteFragment: BaseFragment<FragmentRemindWriteBinding, RemindViewModel>() {
    ...
    private fun startRmdindDetailWrite() {
        binding.tvWeekGoodContent.setOnClickListener{ startRemindDetailWriteActivityWithAction(binding.tvWeekGoodContent, binding.tvWeekGoodTitle) }
        binding.tvWeekBadContent.setOnClickListener{ startRemindDetailWriteActivityWithAction(binding.tvWeekBadContent, binding.tvWeekBadTitle) }
        binding.tvNextWeekContent.setOnClickListener{startRemindDetailWriteActivityWithAction(binding.tvNextWeekContent, binding.tvNextWeekTitle)}
    }
